				...
				<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
						...
						<ul class="menu-nav">
							...
							@canany(['Read-Institutions','Create-Institution','Read-InvitationGroups','Create-InvitationGroup','Read-Invitations','Create-Invitation'])
								...
								<div class="menu-submenu">
									...
									<ul class="menu-subnav">
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('institutions.create')}}" class="menu-link">
							...
							@endcanany
							@canany(['Read-InvitationGroups','Create-InvitationGroup'])
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								<a href="javascript:;" class="menu-link menu-toggle">
									<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
								...
								<div class="menu-submenu">
									...
									<ul class="menu-subnav">
										...
										@can('Create-InvitationGroup')
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('invitation-groups.create')}}" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">Create</span>
										...
										@endcan
										@can('Read-InvitationGroups')
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('invitation-groups.index')}}" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">Index</span>
							...
							@endcanany
							@canany(['Read-Invitations','Create-Invitation'])
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								<a href="javascript:;" class="menu-link menu-toggle">
									<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
							...
							@canany(['Read-Admins','Create-Admin','Read-Stores','Create-Store','Read-Users','Create-User'])
							<li class="menu-section">
							...
							@endcanany
							@canany(['Read-Stores','Create-Store'])
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								<a href="javascript:;" class="menu-link menu-toggle">
									<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
								...
								<div class="menu-submenu">
									...
									<ul class="menu-subnav">
										...
										@can('Create-Store')
										<li class="menu-item" aria-haspopup="true">
											<a href="{{route('stores.create')}}" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">Create</span>
							...
							@canany(['Create-City','Read-Cities','Create-FAQs','Read-FAQs'])
							<li class="menu-section">
							...
							@canany(['Create-Category','Read-Category','Create-SubCategory','Read-SubCategories','Create-Product','Read-Products','Create-Offer','Read-Offers'])
							<li class="menu-section">
							...
							<li class="menu-item" aria-haspopup="true">
								<a @cannot('Update-SystemSettings') href="{{route('system-settings.index')}}"
									@elsecan('Update-SystemSettings') href="{{route('system-settings.create')}}" @endcan
									class="menu-link">
									<span class="svg-icon menu-icon">
	...
	<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
		...
		<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
			...
			<div class="text-dark order-2 order-md-1">
				...
				<a href="#" target="_blank" class="text-dark-75 text-hover-primary">{{env('APP_NAME')}} - Momen
					Sisalem</a>
				{{-- target="_blank" --}}
			</div>
			<!--end::Copyright-->
