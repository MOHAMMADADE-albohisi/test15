                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pl-0">
                            ...
                            <span class="text-muted font-weight-bold">{{$user->store_name}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$user->mobile}}</span>
                            <span class="text-muted font-weight-bold">{{$user->city->name_en}}</span>
                        </td>
                        <td>
                            <span
                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{$user->gender_name}}</span>
                        </td>
                        <td>
                            <span
